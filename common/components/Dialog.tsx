...
export default function Dialog(props: Props) {
  ...
  return (
    ...
    >
      <section
        className={
          'delay-400 -3 absolute left-3 right-3 top-1/2 bottom-auto min-h-[150px] transform rounded-2xl bg-bg2 transition-all duration-500 ease-in-out md:mx-auto md:max-w-sm ' +
          className +
